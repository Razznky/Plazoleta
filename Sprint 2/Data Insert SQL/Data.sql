INSERT INTO departamentos (nombre) VALUES ('Atlántico'), ('Bolívar'), ('Magdalena'), ('Antioquia');

INSERT INTO ciudades (nombre, id_departamento) VALUES ('Barranquilla', 1), ('Soledad', 1), ('Puerto Colombia', 1), ('Cartagena', 2), ('Santa Marta', 3), ('Medellín', 4);

INSERT INTO tipo_de_documento (nombre, descripcion) VALUES ('CC', 'Cédula de Ciudadanía Colombiana'), ('CE', 'Cédula de Extranjería');

INSERT INTO categoria_restaurante (nombre, descripcion) VALUES ('Sabor Local', 'Cocina tradicional de la Costa Caribe'), ('Express', 'Comidas rápidas de alta calidad'), ('Green', 'Opciones fitness y balanceadas');

INSERT INTO estado_restaurante (nombre, descripcion) VALUES ('Activo', 'Abierto y operando'), ('Inactivo', 'Cerrado o en remodelación');
...
INSERT INTO estado_cliente (nombre, descripcion) VALUES ('Activo', 'Usuario con permisos de compra'), ('Inactivo', 'Usuario bloqueado o suspendido');
...
INSERT INTO cargos (nombre, descripcion, salario_base) VALUES ('Líder de Punto', 'Administrador general del restaurante', 2800000), ('Chef de Cocina', 'Encargado de la producción culinaria', 1800000), ('Auxiliar Logístico', 'Apoyo en servicio y entrega', 1300000);
...
INSERT INTO horario_empleados (id_empleado, dia_de_semana, horario_inicio, horario_fin) VALUES (1, 'Lunes', '08:00:00', '16:00:00'), (2, 'Martes', '09:00:00', '17:00:00'), (3, 'Miércoles', '08:00:00', '16:00:00'), (4, 'Jueves', '10:00:00', '18:00:00'), (5, 'Viernes', '08:00:00', '16:00:00'), (6, 'Sábado', '09:00:00', '15:00:00'), (7, 'Lunes', '12:00:00', '20:00:00'), (8, 'Martes', '08:00:00', '16:00:00'), (9, 'Miércoles', '10:00:00', '18:00:00'), (10, 'Jueves', '09:00:00', '17:00:00');

INSERT INTO categoria_plato (nombre, descripcion) VALUES ('Entradas', 'Fritos y aperitivos caseros'), ('Platos Fuertes', 'Almuerzos y cenas especializadas'), ('Bebidas', 'Jugos naturales y café de origen');

INSERT INTO estado_plato (nombre, descripcion) VALUES ('Disponible', 'Plato con insumos completos'), ('Agotado', 'No disponible en el menú actual');

INSERT INTO plato (nombre, descripcion, costo, tiempo_preparacion_min, codigo_interno, imagen_url, disponible, orden_visual, categoria_plato_id, estado_id) VALUES 
('Hamburguesa La Simón', 'Res 150g, queso costeño, suero y cebolla caramelizada', 24500, 15, 'HAM-BK-01', 'https://[Log in to view URL]', 1, 1, 2, 1),
('Arroz con Pollo Criollo', 'Receta tradicional con verduras picadas y papas a la francesa', 18500, 20, 'ARR-PL-02', 'https://[Log in to view URL]', 1, 2, 2, 1),
('Pizza Pepperoni Familiar', 'Masa artesanal delgada, mozzarella y pepperoni madurado', 38000, 25, 'PIZ-FAM-03', 'https://[Log in to view URL]', 0, 3, 2, 2),
('Pasta Carbonara USB', 'Penne en salsa blanca artesanal, tocineta y parmesano', 29000, 18, 'PAS-USB-04', 'https://[Log in to view URL]', 1, 4, 2, 1),
('Tacos de Pastor x3', 'Tortilla de maíz artesanal, cerdo al achiote y piña fresca', 21000, 12, 'TAC-MEX-05', 'https://[Log in to view URL]', 1, 5, 2, 1),
('Bowl Fitness Campus', 'Mix de lechugas, pechuga a la plancha, quinua y aguacate', 23500, 15, 'BWL-FIT-06', 'https://[Log in to view URL]', 1, 6, 1, 1),
('Limonada de Coco', 'Granizado natural preparado con crema de coco real', 11500, 8, 'BEB-LIMO-07', 'https://[Log in to view URL]', 1, 7, 3, 1),
('Punta de Anca 300g', 'Corte de res a la parrilla servido con yuca frita y guiso', 45000, 25, 'CAR-PNT-08', 'https://[Log in to view URL]', 0, 8, 2, 2),
('Deditos de Queso x6', 'Pasabocas fritos rellenos de queso costeño derretido', 14000, 10, 'ENT-DED-09', 'https://[Log in to view URL]', 1, 9, 1, 1),
('Cappuccino 12oz', 'Café espresso especial con leche vaporizada y espuma cremosa', 7500, 5, 'CAF-CP-10', 'https://[Log in to view URL]', 1, 10, 3, 1);

INSERT INTO tipo_de_ingrediente (nombre, descripcion) VALUES ('Proteínas', 'Carnes, aves y pescados frescos'), ('Vegetales', 'Verduras y hortalizas de temporada'), ('Lácteos', 'Quesos y derivados procesados'), ('Granos', 'Arroz, harinas y cereales');

INSERT INTO ingredientes (nombre, descripcion, id_tipo_ingrediente) VALUES ('Carne de Res 150g', 'Medallón de res para hamburguesa', 1), ('Queso Costeño', 'Queso rallado salado', 3), ('Pechuga de Pollo', 'Filete de pollo fresco', 1), ('Arroz Blanco', 'Grano largo premium', 4);

INSERT INTO ingredientes_requeridos (id_plato, id_ingrediente, cantidad_requerida) VALUES (1, 1, 1), (1, 2, 50), (2, 3, 1), (2, 4, 200);

INSERT INTO existencias_de_ingredientes_en_restaurantes (id_ingrediente, id_restaurante, cantidad_en_existencia) VALUES (1, 1, 100), (2, 1, 5000), (3, 2, 80), (4, 4, 10000);

INSERT INTO tipo_entrega (nombre, descripcion) VALUES ('Recogida', 'El cliente retira en el punto físico'), ('Domicilio', 'Entrega en la dirección del cliente');

INSERT INTO estado_pedidos (nombre, descripcion) VALUES ('En preparación', 'El pedido está siendo cocinado'), ('En reparto', 'El motorizado está en camino'), ('Entregado', 'El pedido llegó a su destino');

INSERT INTO metodos_de_pago (nombre, descripcion) VALUES ('Efectivo', 'Pago manual al recibir'), ('Transferencia', 'Pago vía Nequi o Daviplata'), ('Tarjeta', 'Pago mediante datáfono');
